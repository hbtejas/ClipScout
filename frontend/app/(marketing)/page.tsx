  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white selection:bg-white selection:text-black font-sans">
      ...
      <main className="relative z-10 pt-28 sm:pt-36">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-white/10 relative">
          <div className="text-center space-y-3 mb-16">
            <p className="text-lg sm:text-xl font-medium text-white max-w-4xl mx-auto">
              Bring your own model — FalconVQA supports these providers
            </p>
          </div>

          <div className="relative grid grid-cols-2 md:grid-cols-4 border border-white/10 max-w-5xl mx-auto">
            {/* OpenAI Card */}
            <div className="group relative flex flex-col items-center justify-center p-8 border-b md:border-b-0 border-r border-white/10 transition-all duration-300 hover:bg-white/5">
              <div className="flex items-center justify-center rounded-2xl bg-white p-4 shadow-md h-20 w-36 group-hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-black text-base tracking-tight">OpenAI</span>
                </div>
              </div>
              <span className="mt-4 text-[10px] font-mono uppercase tracking-widest text-neutral-400 font-semibold">
                OpenAI
              </span>
            </div>

            {/* Gemini Card */}
            <div className="group relative flex flex-col items-center justify-center p-8 border-b md:border-b-0 border-r-0 md:border-r border-white/10 transition-all duration-300 hover:bg-white/5">
              <div className="flex items-center justify-center rounded-2xl bg-white p-4 shadow-md h-20 w-36 group-hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-neutral-900 text-base tracking-tight">Gemini</span>
                </div>
              </div>
              <span className="mt-4 text-[10px] font-mono uppercase tracking-widest text-neutral-400 font-semibold">
                Gemini
            ...
            {/* Groq Card */}
            <div className="group relative flex flex-col items-center justify-center p-8 border-r border-white/10 transition-all duration-300 hover:bg-white/5">
              <div className="flex items-center justify-center rounded-2xl bg-white p-4 shadow-md h-20 w-36 group-hover:scale-105 transition-transform duration-300">
                <span className="font-black text-[#F55036] text-xl tracking-tighter lowercase font-sans">
                  groq
                </span>
              </div>
              <span className="mt-4 text-[10px] font-mono uppercase tracking-widest text-neutral-400 font-semibold">
            ...
            {/* Cerebras Card */}
            <div className="group relative flex flex-col items-center justify-center p-8 transition-all duration-300 hover:bg-white/5">
              <div className="flex items-center justify-center rounded-2xl bg-white p-4 shadow-md h-20 w-36 group-hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-bold text-black text-sm tracking-tight lowercase">cerebras</span>
                </div>
              </div>
              <span className="mt-4 text-[10px] font-mono uppercase tracking-widest text-neutral-400 font-semibold">
                Cerebras
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2 flex flex-col items-start lg:items-end text-left lg:text-right space-y-3">
              <h2 className="text-3xl font-medium tracking-tight text-white">FalconVQA</h2>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between text-xs text-neutral-500 font-mono">
            <p>© 2026 FalconVQA / ClipScout. All rights reserved.</p>
