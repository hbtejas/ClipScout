  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white selection:bg-white selection:text-black font-sans">
      ...
      <main className="relative z-10 pt-28 sm:pt-36">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-white/10 relative">
          <div className="text-center space-y-3 mb-12">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/5 border border-white/15 text-[11px] font-mono text-neutral-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-full aspect-[2.2/1] bg-white rounded-3xl p-5 flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-center space-y-1">
                ...
                <span className="inline-block text-[10px] font-mono px-3 py-0.5 rounded-full bg-white/10 text-neutral-300 border border-white/15">
                  VLM + Audio
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-full aspect-[2.2/1] bg-white rounded-3xl p-5 flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-300">
                <div className="flex items-center">
                  <span className="font-black text-[#F55036] text-3xl tracking-tighter lowercase font-sans">
                    groq
                  </span>
                </div>
              </div>
